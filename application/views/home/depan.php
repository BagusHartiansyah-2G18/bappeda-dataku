<link href="<?php echo base_url()?>assets/css/pages/support-center/home-2.css" rel="stylesheet" type="text/css" />
...
<div class="kt-portlet kt-sc-2">
		...
		<div class="kt-sc__top">
			<div class="kt-sc__content">
				<h2 class="kt-sc__title">
					<img src="<?php echo base_url('uploads/ksb.png') ?>"> <br><br>
					Aplikasi Dataku
				</h2>
				<form class="kt-sc__form">
					<div class="input-group">
						...
						<input type="text" class="form-control" placeholder="Masukan Kata Kunci Pencarian" aria-describedby="basic-addon1">
					</div>
				</form>
			</div>
		</div>
	...
	<div class="kt-sc__bottom">
		<ul class="nav nav-tabs  nav-tabs-line" role="tablist">
			...
			<li class="nav-item">
				<a class="nav-link" href="<?php echo site_url('home/sdgs') ?>" >SDGS</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="<?php echo site_url('home/data_utama') ?>">DATA UTAMA</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="<?php echo site_url('home/data_dasar') ?>">DATA DASAR</a>
			</li>
			<li class="nav-item">
...
<script type="text/javascript">
	...
	$('#kt_wrapper').removeClass('kt-wrapper');
	$('#kt_header_mobile').addClass('d-none');
</script>