		...
		<div class="container clearfix">
			...
			<div class="single-post nobottommargin clearfix ">
				...
				<div class="row mb-6">
					<div class="col-md-6">
						<div class="row">
							<div class="col-12 font-weight-bold text-uppercase text-primary">
								<?php echo $row->judul; ?>
							</div>
							<div class="col-md-3">
								Bidang Urusan
					...
					<div class="col-md-6 chart">
						<div class="tabs tabs-alt tabs-tb clearfix" id="tab-8">
							...
							<div class="tab-container">
								...
								<canvas id="chart_<?php echo $row->id; ?>" style="max-height: 250px;" label="<?php echo $row->tahun; ?>" nilai="<?php echo $row->nilai; ?>" judul="<?php echo $row->nama_elemen; ?>"></canvas>
							</div>
						</div>
					</div>
				</div>
